...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ##
atlantisMerged -i final_test_input_zoo.nc 0 -o output.nc -r SO28_run.prm -f SO28_force.prm -p SO28_physics.prm -b SO28_biol.prm -h SO28_harvest_nofishing.prm -s AntarcticGroupsnew.csv -d output_test1
